...
//-------------------------------------------------------------------
// 公共登录弹框
var loginHtml = '<div class="login_box"><div class="login"><h3>登录</h3><em class="login_close"></em><label class="tel"><span class="title">手机号</span><input type="text" maxlength="11" placeholder="请输入手机号码"></label><label class="pic_mess"><span class="title">图形验证码</span><input type="text" placeholder="请输入右侧验证码" maxlength="4"><span class="pic_code"><img src="/Home/House/verufy.html"></span></label><label class="sm"><span class="title">短信验证码</span><input type="text" maxlength="6" placeholder="请输入短信验证码"><button class="get_code">获取验证码</button></label><a href="javascript:;" class="login_btn opacity common_btn">立即登录</a></div></div>';
         ...
         if (metroArr.length != 0) {
              ...
              if (metroArr.length <= 3) {
                for(var i=0;i<metroArr.length;i++){
                  metroList += '<li><a href="'+get_city_url+'dtlist1/a'+metroArr[i].id+'/b0/c0/d0/e0/f0/g0/h0/?key='+metroArr[i].estate_name+'"><p>'+metroArr[i].estate_name+'</p><span>'+metroArr[i].type_name+'</span></a></li>';
                }
                metroList += '</ul></div>';
                ...
                for(var i = 3;i < metroArr.length;i++){
                  metroList += '<a href="'+get_city_url+'dtlist1/a'+metroArr[i].id+'/b0/c0/d0/e0/f0/g0/h0/?key='+metroArr[i].estate_name+'">'+metroArr[i].estate_name+'</a>';
                }
                metroList += '</div></div>';
              };
            ...
            if (xzArr.length != 0) {
              ...
              if (xzArr.length <= 3) {
                for(var i=0;i<xzArr.length;i++){
                  xzList += '<li><a href="'+get_city_url+'sqlist1/a'+xzArr[i].id+'/b0/c0/d0/e0/f0/g0/h0/?key='+xzArr[i].estate_name+'"><p>'+xzArr[i].estate_name+'</p><span>'+xzArr[i].type_name+'</span></a></li>';
                }
                xzList += '</ul></div>';
                ...
                for(var i = 3;i < xzArr.length;i++){
                  xzList += '<a href="'+get_city_url+'sqlist1/a'+xzArr[i].id+'/b0/c0/d0/e0/f0/g0/h0/?key='+xzArr[i].estate_name+'">'+xzArr[i].estate_name+'</a>';
                }
                xzList += '</div></div>';
              };
            ...
            if (regionArr.length != 0) {
              ...
              if (regionArr.length <= 3) {
                for(var i=0;i<regionArr.length;i++){
                  ...
                  regionList += '<li><a href="'+get_city_url+'sqlist2/a'+regionId+'/b'+regionArr[i].id+'/c0/d0/e0/f0/g0/h0/?key='+regionArr[i].estate_name+'"><p>'+regionArr[i].estate_name+'</p><span>'+regionArr[i].type_name+'</span></a></li>';
                }
                regionList += '</ul></div>';
                ...
                for(var i = 3;i < regionArr.length;i++){
                  regionList += '<a href="'+get_city_url+'sqlist2/a'+regionId+'/b'+regionArr[i].id+'/c0/d0/e0/f0/g0/h0/?key='+regionArr[i].estate_name+'">'+regionArr[i].estate_name+'</a>';
                }
                regionList += '</div></div>';
              };
            ...
            if (gyArr.length != 0) {
              ...
              for(var i=0;i<gyArr.length;i++){
                gyList += '<li><a href="'+get_city_url+'sqlist1/a0/b0/c0/d0/e0/f0/g0/h0/?key_self='+gyArr[i].result_no+'&key='+gyArr[i].estate_name+'&search_id='+gyArr[i].id+'&type_no='+gyArr[i].type_no+'"><p>'+gyArr[i].estate_name+'</p><span>'+gyArr[i].type_name+'</span></a></li>';
              }
              gyList += '</ul></div>';
            ...
            if (xqArr.length != 0) {
              ...
              if (xqArr.length <= 3) {
                for(var i = 0;i < xqArr.length;i++){
                  xqList += '<li><a href="'+get_city_url+'sqlist1/a0/b0/c0/d0/e0/f0/g0/h0/?key_self='+xqArr[i].result_no+'&key='+xqArr[i].estate_name+'&search_id='+xqArr[i].id+'&type_no='+xqArr[i].type_no+'"><p>'+xqArr[i].estate_name+'</p><em>'+xqArr[i].estate_address+'</em><span>'+xqArr[i].type_name+'</span></a></li>';
                }
                xqList += '</ul></div>';
                ...
                for(var i = 3;i < xqArr.length;i++){
                  xqList += '<a href="'+get_city_url+'sqlist1/a0/b0/c0/d0/e0/f0/g0/h0/?key_self='+xqArr[i].result_no+'&key='+xqArr[i].estate_name+'&search_id='+xqArr[i].id+'&type_no='+xqArr[i].type_no+'">'+xqArr[i].estate_name+'</a>';
                }
                xqList += '</div></div>';
              };
...
$(".input_box").keydown(function(e){
  ...
  if (keycode == '13') {//按了enter键
    ...
    if (val == '') {
        var get_city_url=$("#get_city_url").val();
       window.location.href = get_city_url+'sqlist1/a0/b0/c0/d0/e0/f0/g0/h0/';
    }else{
